...
#ifndef INC_IMUFILTER_H_
#define INC_IMUFILTER_H_
...
#define GyroMeasError  3.14159265359 * (40.0f / 180.0f)
// gyroscope measurement drift in rad/s/s (start at 0.0 deg/s/s)
#define GyroMeasDrift  3.14159265359 * (0.0f  / 180.0f)
...
/*
float GetPitchFromQ(float q[4])
{
	return -asin(2.0f * (q[1] * q[3] - q[0] * q[2]))*(180.0f/3.14159265359);
	}
float GetRollFromQ(float q[4])
{
	return atan2(2.0f * (q[0] * q[1] + q[2] * q[3]),
			q[0] * q[0] - q[1] * q[1] - q[2] * q[2] + q[3] * q[3])*(180.0f/3.14159265359);
	}
*/
#endif /* INC_IMUFILTER_H_ */
